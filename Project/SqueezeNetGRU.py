...
for epoch in range(num_epochs):
  ...
  if epoch % 10 == 0:
    ...
    torch.save(lstm.state_dict(), results_path+ '/' + model_name +'iter_%d_gru.pkl'%(epoch))
    print('saving '+results_path+ '/' + model_name +'iter_%d_gru.pkl'%(epoch))
...
for iteration in range(0, num_epochs, 10):
	...
	lstm_file = '/' + model_name +'iter_%d_gru.pkl'%(iteration)
...
lstm_file = '/' + model_name +'iter_%d_gru.pkl'%(num_epochs - 1)
